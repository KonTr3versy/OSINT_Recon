...
- Passive subdomains: aggregated from `crt.sh`, `Cert Spotter`, and `dns.bufferover.run`, then normalized/deduplicated.
- Passive users: aggregated from GitHub user search and Keybase autocomplete using domain/company query variants, with confidence labels for triage.
