...
- Passive subdomains: aggregated from `crt.sh`, `Cert Spotter`, `dns.bufferover.run`, and `urlscan.io`, then normalized/deduplicated.
- Passive users: aggregated from GitHub, GitLab, and Keybase user discovery endpoints using domain/company query variants, with confidence labels for triage.
